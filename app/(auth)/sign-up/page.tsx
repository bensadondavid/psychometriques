...
export default function SignUp() {
  ...
  return (
    <div>
      ...
      <p className="mt-6 text-center text-sm text-[#766a5e]">Déjà membre ? <Link href="/sign-in" className="font-semibold text-[#45121d] underline-offset-4 hover:underline">Se connecter</Link></p>
    </div>
  );
}
